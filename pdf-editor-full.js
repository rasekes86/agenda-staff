// ============================================
// PDF EDITOR FULL SCREEN - AGENDA STAFF v5.17.16
// ============================================
...
async function searchSignatures() {
  ...
  try {
    ...
    if (allSignatures.length > 0) {
      ...
      $('signatureResults').innerHTML = '<div class="signature-empty">No se encontraron firmas</div>';
    }
...
function selectSignature(url, name) {
  ...
  img.onload = () => {
    ...
    const countEl = document.querySelector('.signature-count');
    if (countEl) {
